...
public class SEOController {
    ...
    public String getSiteMapXml() {
        ...
        sitemap.append("<urlset\n")
                ...
                .append("<url>\n")
                .append("  <loc>http://store.com.ua/</loc>\n")
                .append("</url>\n");
        ...
        if (!categories.isEmpty()) {
            for (Category category : categories) {
                sitemap.append("<url>\n")
                        .append("  <loc>http://store.com.ua/category_").append(category.getUrl()).append("</loc>\n")
                        .append("</url>\n");
            }
        }
        ...
        if (!products.isEmpty()) {
            sitemap.append("<url>\n")
                    .append("  <loc>http://store.com.ua/all_products</loc>\n")
                    .append("</url>\n");

            for (Product product : products) {
                sitemap.append("<url>\n")
                        .append("  <loc>http://store.com.ua/product_").append(product.getUrl()).append("</loc>\n")
                        .append("</url>\n");
            }
        }
